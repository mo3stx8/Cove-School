...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->validate([
            ...
            'emergency_contact_phone' => ['nullable', 'string', 'max:32', 'regex:/^[0-9+\s\-()]*$/'],
            'medical_notes' => ['nullable', 'string'],
            'father' => ['nullable', 'array'],
            'father.name' => ['nullable', 'string', 'max:255'],
            'father.phone' => ['nullable', 'string', 'max:32', 'regex:/^[0-9+\s\-()]*$/'],
            ...
            'mother.phone' => ['nullable', 'string', 'max:32', 'regex:/^[0-9+\s\-()]*$/'],
            ...
            'guardian.phone' => ['nullable', 'string', 'max:32', 'regex:/^[0-9+\s\-()]*$/'],
